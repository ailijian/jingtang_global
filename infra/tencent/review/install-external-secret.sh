...
case "$name" in
  platform-cam-secret-id|platform-cam-secret-key|worker-cam-secret-id|worker-cam-secret-key|backup-cam-secret-id|backup-cam-secret-key|youtube-client-secret|facebook-app-secret|tiktok-client-secret) ;;
  *)
