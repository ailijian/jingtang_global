export const en = {
  ...
  "composer.asset.help":
    "MP4, MOV, JPG, PNG, or WebP. The original is stored privately and never branded by JINGTANG.",
  ...
  "composer.platform.youtube": "YouTube review target",
  "composer.platform.youtube.help":
    "Preparation and approval only. No channel is connected and no upload will occur in D4.",
  "composer.platform.accountReference": "Account reference",
  ...
  "detail.approvalNoPublish":
    "Approval is complete. Publishing remains a separate, unavailable action.",
