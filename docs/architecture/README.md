...
| DNS and Search Console ownership | Cloudflare and Google public resolvers return the Human-controlled Tencent production host; HTTPS certificate is valid; Search Console verification remains external | JINGTANG Infrastructure Owner | GoDaddy registrar, production DNS/TLS, and future Search Console evidence | D3 accepted; Google verification remains |
