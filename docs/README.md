...
| A Delivery's Goal, User Outcome, Non-goals, Key Decisions, Preserved Constraints, and Acceptance Criteria | `docs/deliveries/<delivery-id>/BASELINE.md`; current owner: [V1 Baseline](deliveries/jingtang-overseas-website-saas-v1-launch/BASELINE.md) | `approved_target` after approval | Delivery-scoped. |
| A Delivery's stages, Gates, verification, and execution records | `docs/deliveries/<delivery-id>/PLAN.md`; current owner: [V1 Plan](deliveries/jingtang-overseas-website-saas-v1-launch/PLAN.md) | `execution_only` | Exists only after formal planning; Delivery-scoped. |
