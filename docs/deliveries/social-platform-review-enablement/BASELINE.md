...
- Instagram 的 COS 签名媒体 URL 属于 Secret-equivalent 临时授权；必须对象/方法绑定、最小 TTL、全链路脱敏且不持久化。该拉取例外不放宽私有 Bucket、500 MiB、内容 hash/size 冻结、单 worker 并发或其他平台的媒体传输边界。
